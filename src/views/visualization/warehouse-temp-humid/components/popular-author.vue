<template>
  <a-spin :loading="loading" style="width: 100%">
    <a-card class="general-card" :header-style="{ paddingBottom: '14px' }">
      <template #title>
        {{ $t('warehouseTempHumid.popularAuthor') }}
      </template>
      <template #extra>
      ...
      <a-table :data="tableData.list" :pagination="false" :bordered="false" style="margin-bottom: 20px" :scroll="{ x: '100%', y: '350px' }">
        <template #columns>
          <a-table-column :title="$t('warehouseTempHumid.popularAuthor.column.ranking')" data-index="ranking"></a-table-column>
          <a-table-column :title="$t('warehouseTempHumid.popularAuthor.column.author')" data-index="author"></a-table-column>
          <a-table-column
            :title="$t('warehouseTempHumid.popularAuthor.column.content')"
          ...
          ></a-table-column>
          <a-table-column
            :title="$t('warehouseTempHumid.popularAuthor.column.click')"
