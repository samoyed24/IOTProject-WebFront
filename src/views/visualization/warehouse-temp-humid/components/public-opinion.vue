<template>
  <a-card class="general-card" :title="$t('warehouseTempHumid.title.publicOpinion')" :header-style="{ paddingBottom: '12px' }">
    <a-grid :cols="24" :col-gap="12" :row-gap="12">
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 6, xxl: 6 }">
        <ChainItem
          :title="$t('warehouseTempHumid.card.title.allVisitors')"
          quota="visitors"
          chart-type="line"
          :card-style="{
      ...
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 6, xxl: 6 }">
        <ChainItem
          :title="$t('warehouseTempHumid.card.title.contentPublished')"
          quota="published"
          chart-type="bar"
          :card-style="{
      ...
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 6, xxl: 6 }">
        <ChainItem
          :title="$t('warehouseTempHumid.card.title.totalComment')"
          quota="comment"
          chart-type="line"
          :card-style="{
      ...
      <a-grid-item :span="{ xs: 12, sm: 12, md: 12, lg: 12, xl: 6, xxl: 6 }">
        <ChainItem
          :title="$t('warehouseTempHumid.card.title.totalShare')"
          quota="share"
          chart-type="pie"
          :card-style="{
